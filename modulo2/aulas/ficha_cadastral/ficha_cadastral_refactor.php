...
if ($sexo == 'M') {
    $anos_para_aposentar = 65; // número fixo no código = magic numbers
} else {
    $anos_para_aposentar = 60;
}
$anos_para_aposentar -= $idade;
...
<body>
    <div class="container">
        <div class="card">
            ...
            <p>Anos para Aposentadoria: <strong><?= $anos_para_aposentar ?></strong></p>
