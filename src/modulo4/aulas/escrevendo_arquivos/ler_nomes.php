...
// $arquivo = fopen("nomes.txt",'r') - dará erro pois o descriptor 'r' é apenas para leitura, essa limitação ocorre a favor de uma proteção
$arquivo = fopen("nomes3.txt","a");
fwrite($arquivo, 'Jojoddd');
fclose($arquivo);