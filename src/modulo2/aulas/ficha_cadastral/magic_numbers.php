<?php
// MAGIC NUMBERS
// São valores que não possue um significado real no código, foram escritos "hard coded" para que o algoritmo funcione, mas ruim para manutenção.

// Uma forma de evitar magic numbers é armazenando os valores CONSTANTES dentro de variáveis e utilizá-las
// Outra forma MELHOR ainda é utilizar CONSTANTES para armazenar esses valores
...
if ($sexo == 'M') {
    $total_aposentar = IDADE_APOSENTADORIA_MASCULINA;
} else {
    $total_aposentar = IDADE_APOSENTADORIA_FEMININA;
}
