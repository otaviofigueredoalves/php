...
// number_format()
// = -> representa valor padrão, ou seja, não é necessário formatar aquele dado
// ex: int $decimals = 0; -> DIZ QUE OS DECIMAIS NÃO IRÃO APARECER NA TELA
// (?) -> representa dado opcional
